#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""public化前に翻訳内容へ触れず、状態・owner・wave・manifestを一括検査する。"""
...
CHECKS = [
    ["check_operation_mode.py", "--repository-visibility", "private"],
...
def main() -> int:
    ...
    if failures:
        print("\nFAILED private release preflight: " + ", ".join(failures))
        return 1
    print("\nOK: private release preflight passed; public CI may be requested")
    return 0
