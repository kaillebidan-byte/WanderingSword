#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""翻訳作業、翻訳凍結、CI輸送、phase2単一PR最終化を検査する。"""
...
def validate_operation_mode(current: dict[str, Any]) -> list[str]:
    ...
    for key in ("open_pr_only_after_ready", "draft_train_pr_allowed_while_private", "train_release_requires_manifest_ready", "public_translation_forbidden", "deep_failure_returns_private"):
