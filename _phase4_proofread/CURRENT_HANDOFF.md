...
- active train: `yuwen-mowen-train-71`
- branch: `agent/yuwen-mowen-train-71`
- stage: `private_quality_audit`
- transport: `not_ready`
- wave: `yuwen-mowen-train-71-wave-01` / 1 packet / 65 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES6155_1_6229_1_2026-07-31.json`
- previous release: `yuwen-mowen-train-70` / PR #227 / `d3cf6158d2a78ee2bc2a5bbd1082aaf261374047`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES6155_1_6229_1_2026-07-31.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
