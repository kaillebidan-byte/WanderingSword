...
- transport: `not_ready`
- wave: `yuwen-mowen-train-74-wave-01` / 1 packet / 46 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9234_6_9245_3_2026-08-01.json`
- previous release: `yuwen-mowen-train-73` / PR #230 / `4c38470e917cf84f1073214c69710fdd3037efa6`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9234_6_9245_3_2026-08-01.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
