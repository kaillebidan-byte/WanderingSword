...
- active train: `yuwen-mowen-train-45`
- branch: `agent/yuwen-mowen-train-45`
- stage: `private_quality_audit`
- transport: `not_ready`
- wave: `yuwen-mowen-train-45-wave-01` / 1 packet / 55 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9016_1_9230_2_2026-07-30.json`
- previous release: `yuwen-mowen-train-44` / PR #200 / `12c9fe255da9d211308929ca3c7b3ff1a0f5d381`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9016_1_9230_2_2026-07-30.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
