...
- active train: `yuwen-mowen-train-49`
- branch: `agent/yuwen-mowen-train-49`
- stage: `private_quality_audit`
- transport: `not_ready`
- wave: `yuwen-mowen-train-49-wave-01` / 1 packet / 56 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES22020_8_32007_1_2026-07-30.json`
- previous release: `yuwen-mowen-train-48` / PR #205 / `837b2ee2d605e844fa2c8dd10ae3c6a259484c8e`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES22020_8_32007_1_2026-07-30.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
