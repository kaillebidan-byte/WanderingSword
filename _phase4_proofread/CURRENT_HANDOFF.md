...
- active train: `yuwen-mowen-train-42`
- branch: `agent/yuwen-mowen-train-42`
- stage: `private_quality_audit`
- transport: `not_ready`
- wave: `yuwen-mowen-train-42-wave-01` / 1 packet / 73 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES5821_1_5928_7_2026-07-30.json`
- previous release: `yuwen-mowen-train-41` / PR #197 / `f2f8abfe2b3ee25e452eabac480093f0dc09dddc`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES5821_1_5928_7_2026-07-30.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
