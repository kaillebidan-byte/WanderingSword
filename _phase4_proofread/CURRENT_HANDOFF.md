...
- active train: `yuwen-mowen-train-46`
- branch: `agent/yuwen-mowen-train-46`
- stage: `private_quality_audit`
- transport: `not_ready`
- wave: `yuwen-mowen-train-46-wave-01` / 1 packet / 53 unique rows
- candidate: `_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9231_3_9233_4_2026-07-30.json`
- previous release: `yuwen-mowen-train-45` / PR #201 / `9a3dce9ebe1fd30abe4b734f74a0e3a227b525a8`

## exact next action

`_phase4_proofread/CANDIDATE_YUWEN_MOWEN_SCENES9231_3_9233_4_2026-07-30.json`を読み、KEEP/FIX・人物性・事実・典故だけを監査する。
