...
宇文逸の目前の異変への反応を直接的にし、発話中の曹煜天を「意識を失っている」とする矛盾を「正気を失っている」へ正した。

二キーを既存owner`fixes_relation_yuwen_mowen_20260723_batch11.json`へ再収録し、残る五行は保持した。走火入魔の原因と救援後の結果は補っていない。
